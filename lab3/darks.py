...
def darks(arg):
    ...
    # secs = int(arg)
    # data = glob('/home/data/Planet_Transit/HD209458/SI/*')
    # data.sort()
    ...
    darks = glob('/home/data/Planet_Transit/HD189733/darks/dark_3s/*')
    darks.sort()
    for j5 in np.arange(len(darks)):
        a5 = fits_load(darks[j5])
        fitsList.append(a5)
    avg_dark = fitsList[0]
    for i in range(19):
    ...
    hdulist.writeto("hd189darks.fits")
